...
async def save_h7_form_b2c_async(
    ...
    try:
        ...
        """), {
            ...
            "warenwert_gesamt": str(form_data.general_data.warenwert_gesamt),
            "waehrung": form_data.general_data.waehrung,
            "versandkosten": str(form_data.general_data.versandkosten),
            "versicherungskosten": str(form_data.general_data.versicherungskosten) if form_data.general_data.versicherungskosten else None,
            "gesamtbetrag_zoll": str(form_data.general_data.gesamtbetrag_zoll) if form_data.general_data.gesamtbetrag_zoll else None,
        ...
        for pos_data in form_data.goods_data.positions:
            ...
            """), {
                ...
                "stueckpreis": str(pos_data.stueckpreis),
                "gesamtwert": str(pos_data.gesamtwert),
                "ursprungsland_iso": pos_data.ursprungsland_iso,
                "zolltarifnummer": pos_data.zolltarifnummer,
                "gewicht": str(pos_data.gewicht) if pos_data.gewicht else None,
