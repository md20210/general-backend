...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('personal', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('unique_angles', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('job_analysis', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('fit_score', sa.Integer(), nullable=True),
        sa.Column('fit_breakdown', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        ...
        sa.Column('probability_factors', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('recommendation', sa.String(), nullable=True),
        sa.Column('salary_min', sa.Integer(), nullable=True),
        sa.Column('salary_max', sa.Integer(), nullable=True),
        sa.Column('salary_currency', sa.String(), nullable=True),
        sa.Column('green_flags', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('red_flags', postgresql.JSON(astext_type=sa.Text()), nullable=True),
        sa.Column('cover_letter_text', sa.Text(), nullable=True),
        sa.Column('cv_customization', postgresql.JSON(astext_type=sa.Text()), nullable=True),
