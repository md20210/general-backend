...
def upgrade():
    ...
    # Create job_assistant_profiles table (skip if exists)
    if 'job_assistant_profiles' not in inspector.get_table_names():
        op.create_table(
    ...
    # Create job_applications table (skip if exists)
...
def downgrade():
    ...
    if 'job_assistant_profiles' in inspector.get_table_names():
